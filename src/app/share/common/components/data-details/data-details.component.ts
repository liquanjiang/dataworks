...
export class DataDetailsComponent implements OnInit {
    ...
    showColumnDetails = false; // 存放是否显示字段的详情
    ColumnDetailData = {}; // 存放查询的字段的详情
    ...
    getMetaChildren(datapk, childrenType) {
        ...
        this.Columntable = 'dwb/metamanage/query/childmetalist?pk=' + datapk + '&metatype=' + childrenType;
    }
